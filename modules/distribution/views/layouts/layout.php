<?php
use app\modules\admin\assets\MetronicAsset;
use app\modules\admin\assets\MetronicLayoutAsset;
use yii\helpers\Html;
use yii\helpers\Url;

$metronic = MetronicAsset::register($this);
MetronicLayoutAsset::register($this);
$this->context->notify($this);//notification提示
$this->beginPage();
?>
<!DOCTYPE html>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    <!-- BEGIN LOGO -->
                    <div class="page-logo">
                        <a href="<?=Url::toRoute(['/distribution']); ?>">
                            <img src="<?=$metronic->baseUrl; ?>/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?=$metronic->baseUrl; ?>/layouts/layout/img/avatar3_small.jpg" />
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    ...
                                    <li>
                                        <?=Html::a(Html::tag('i','',['class'=>'icon-key']).'退出', ['/distribution/default/logout']); ?>
                                    </li>
                                </ul>
                            </li>
